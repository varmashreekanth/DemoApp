...
<html lang="en">
    ...
    <c:if test="${not empty userSuccess}">
      <div class="alert alert-info">${userSuccess}</div>
    </c:if>
    <c:if test="${not empty postSuccess}">
      <div class="alert alert-info">${postSuccess}</div>
    </c:if>
	</head>
	<body>
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav">  
          <li><a href="load-post-home.do">Add Post</a></li>
          <li><a href="#">Link</a></li>
          <li class="dropdown">
	...
	<div class="no-gutter row">
              ...
              <div class="panel" id="midCol">
                ...
                <div class="panel-body">
                  ...
                  <div class="well">
                          <!--<img src="http://s.bootply.com/assets/example/bg_iphone.png" class="img-responsive">-->
                          <c:forEach items="${publicPosts}" var="videoPost">
                          <h3><a href="http://getbootstrap.com">Bootstrap 3 is Here.</a></h3>
                          <p>
                          <c:forEach items="${videoPost.videoNames}" var="videoObj">
                            <video width="320" height="240" controls>
                              <source src="/SocialNetworkingApp/videoController/${videoObj}.do" type="video/mp4"></source>
                            </video>
                          </c:forEach>
                          </p>
                          <p>
    			...
    			<div class="panel-heading" style="background-color:#111;color:#fff;">Top Stories</div>   
                  ...
                  <c:forEach items="${publicPosts}" var="post">
                      ...
                      <div class="col col-sm-4">
                        ...
                        <div class="text-muted"><small>${post.postedBy}</small></div>
                          <c:forEach items="${post.comment}" var="commentObj">
                            <p>
                            ${commentObj.comment}
                            </p>
                          </c:forEach>
                  ...
                  <hr>
                   ...
                   <div class="row">
                    <div class="col-md-6">
                      <img src="http://www.bootply.com/assets/example/bg_smartphones.jpg" class="img-responsive">
